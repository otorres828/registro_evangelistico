    ...
    <div class="col-span-full bg-white shadow-lg rounded-sm border border-slate-200">
        ...
        <header class="flex justify-between items-start px-5 py-4 border-b border-slate-100">
            ...
            <div>
                ...
                {{-- <input wire:model="buscar"type="text" class=" flex-1 w-auto sm:p-2 bg-slate-50 text-gray-600 rounded-lg shadow me:xl-96 "
                    placeholder="Buscar..."> --}}
                                        ...
                                        <div class="text-center">
                                            @if ($celula->estatus)
                                                <div class="bg-green-500 p-2 font-bold text-white rounded-lg text-xs">
                                                    <p>{{ Carbon\Carbon::parse($celula->estatus)->format('d-M') }}</p>
                                                    <p>{{ Carbon\Carbon::parse($celula->estatus)->isoFormat('h:mm a') }}
                                                    </p>
                                                </div>
                                            @else
                                            ...
                                            <div class="relative inline-flex" x-data="{ open: false }">
                                                ...
                                                <div class="origin-top-right z-10 absolute top-full right-0 min-w-36 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="{{ route('celulas_evangelisticas.visitas', $celula->id) }}"
                                                                class="cursor-pointer font-bold text-sm text-green-600 hover:text-green-800 flex py-1 px-3 hover:bg-gray-200">Ver
                                                                Visitas</a>
                                                        </li>
                                                    </ul>
                                                </div>
