...
<div x-data="{ searchOpen: false }">
    <!-- Button -->
    <button
        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-4 transition duration-150 rounded"
            ...
            <div class="py-4 px-2">
                ...
                <div class="px-2 mb-3 last:mb-0">
                    ...
                    <form action="{{route('celulas.store')}}" method="post">
                        ...
                        <button type="submit" class="mt-6 w-full text-center flex-1 bg-blue-500 hover:bg-blue-700 text-white hover:to-blue-500 p-2 rounded">Agregar Celula</button>
                    </form>
                </div>
