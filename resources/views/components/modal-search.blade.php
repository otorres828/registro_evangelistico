        ...
        <div class="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg"
            ...
            <div class="py-4 px-2">
                ...
                <div class="mb-3 last:mb-0">
                    <div class="text-xs font-semibold text-slate-400 uppercase px-2 mb-2">Busquedas</div>
                    <ul class="text-sm">
                        <li>
                            <a class="flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group"
                                href="https://mansiondecristo.com/enseñanzas" @click="searchOpen = false" @focus="searchOpen = true"
                                ...
                                <span>Enseñanzas Dominicales</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group"
                                href="https://mansiondecristo.com/ministerios" @click="searchOpen = false" @focus="searchOpen = true"
                                @focusout="searchOpen = false">
                                <svg class="w-4 h-4 fill-current text-slate-400 group-hover:text-white group-hover:text-opacity-50 shrink-0 mr-3"
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                <span>Ministerios de la Iglesia</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group"
                                href="https://mansiondecristo.com/noticias" @click="searchOpen = false" @focus="searchOpen = true"
                                @focusout="searchOpen = false">
                                <svg class="w-4 h-4 fill-current text-slate-400 group-hover:text-white group-hover:text-opacity-50 shrink-0 mr-3"
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                <span>Ultimas Noticias de la Iglesia</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group"
                                href="https://www.instagram.com/mansiondecristo/" @click="searchOpen = false" @focus="searchOpen = true"
                                @focusout="searchOpen = false">
                                <svg class="w-4 h-4 fill-current text-slate-400 group-hover:text-white group-hover:text-opacity-50 shrink-0 mr-3"
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                <span>Instagram de la Iglesia</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group"
                                href="https://www.facebook.com/somosmansiondecristo" @click="searchOpen = false" @focus="searchOpen = true"
                                @focusout="searchOpen = false">
                                <svg class="w-4 h-4 fill-current text-slate-400 group-hover:text-white group-hover:text-opacity-50 shrink-0 mr-3"
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                <span>Facebook de la Iglesia</span>
                            </a>
                        </li>
